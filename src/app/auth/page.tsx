  ...
  return (
    <div className="max-w-md mx-auto px-4 py-12">
      ...
      <div className="drop-card rounded-2xl p-6">
        ...
        {/* Google sign-in — hidden on native iOS until the native flow
            is implemented; the existing browser-OAuth bounce is too
            fragile on iPad and would tank App Review. */}
        {mode !== "forgot" && (
          <>
            {!isNative() && (
              <button
