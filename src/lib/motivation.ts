...
const MESSAGES: Record<MotivationTier, MessageSet> = {
  ...
  roast_me: {
    streakActive: [
      ...
      "You worked out today. Somebody tell your belly — it hasn't gotten the memo.",
      "Keep it up and maybe one day you'll look like you work out.",
    ],
    streakAtRisk: [
      "Your streak is about to die and honestly? It saw this coming.",
      "Midnight's coming. Your streak is already picking out a casket.",
      "One workout to save your streak but we both know Netflix and snacks already won.",
      "Your streak believed in you. That was its first mistake.",
      "The clock is ticking and you're scrolling. Your love handles are cheering.",
      "Imagine explaining to people you lost your streak because you were 'tired.' You slept 10 hours.",
      "Skip today and your jeans are gonna start filing noise complaints.",
      "Your streak is begging for its life and you're debating whether to open the app. Pathetic.",
    ],
    streakBroken: [
      "Streak's dead. It didn't even get a funeral — just neglect and pizza.",
      "Back to zero. Fitting. Just like the number of people impressed by your physique.",
      ...
      "Zero. That number look familiar? It's also how many abs you have.",
      "Streak gone. Belly still here though. That thing's loyal.",
    ],
    comeBack1Day: [
      "One day off and you're already getting soft. Softer. Whatever.",
      "Yesterday you chose the couch. Your body chose to store that pizza as fat.",
      "24 hours without a workout. The bar was underground and your gut still couldn't clear it.",
      "One day off and the only muscle you exercised was your jaw at dinner.",
    ],
    comeBack3Days: [
      "3 days MIA. Did you forget how to do a pushup or can you just not get off the floor?",
      "Haven't seen you in 3 days. Your avatar needs to be updated to a wider frame.",
      "3 days off. Your leaderboard rank is in hospice and your waistline is thriving.",
      "3 days. Your muscles didn't atrophy — they packed their bags and left.",
      "People who signed up after you are already ahead. They're also better looking. Coincidence?",
      "3 days of 'rest.' Your fridge did more reps than you.",
    ],
    comeBack7Days: [
      "A whole week? I honestly forgot you existed. So did your fitness goals.",
      "7 days. Your phone gets more exercise from you picking it up to order DoorDash.",
      "A week off. Your muscles didn't forget you — they filed for divorce.",
      "You've been gone so long your body thinks exercise is a myth. Like your abs.",
      "7 days without a workout. At this point the app is just a reminder of what you gave up on.",
      "A week? I've seen gas station hot dogs with more definition than you.",
      "7 days. Your body has officially entered storage mode. Congrats, you're a warehouse.",
      "Gone a whole week. Even your fat cells are getting comfortable — they're putting up curtains.",
    ],
    postWorkout: [
      "You actually did it? Alert the media. The laziest person alive moved on purpose.",
      "Not bad. For someone whose main exercise is lifting excuses.",
      "Look at you, exercising like a real person. Your belly didn't get the invite though.",
      "Wow, a whole workout. Your couch filed a missing persons report.",
      "Finished? Cool. Now do it again tomorrow, which we both know is unlikely.",
      "One workout doesn't undo a week of sitting there like a sack of flour, but it's a start.",
      "Congratulations. You burned enough calories to earn back half a chip. Keep going.",
    ],
  },
};
